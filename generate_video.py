...
class video_builder:
    ...
    def add_lower_image(self):
        ...
        def translate_clip(t, clip):
            ...
            return current_x, self.lower_offset
        ...
        # Adding the animations
        lower_image = lower_image.add_mask()
        lower_image = lower_image.fl(rotate_frame, apply_to='mask')
        lower_image = lower_image.set_position(lambda t: translate_clip(t, lower_image)).set_duration(self.duration)
